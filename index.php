		...
		<div class="section-margin-top">
			<div class="row">
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">Most Popular Countries</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>
				</div>
			</div>
      <div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">Most Popular Cities</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>
				</div>
				<div class="col-lg-6">
					<div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							...
							<span class="tm-home-box-2-description box-3">New York</span>
			     ...
			     <div class="col-lg-6">
			        <div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
					        ...
					        <div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<span class="tm-home-box-2-description box-3">Paris</span>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
						</div>
						</div>
					</div>
